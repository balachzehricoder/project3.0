...
include 'config.php';
    ...
    $sql = "SELECT COUNT(*) AS user_count FROM users"; // Replace 'users' with your table name
...
include 'config.php';
    ...
    // Query to get user count
    $sql = "SELECT COUNT(*) AS user_count FROM orders"; // Replace 'users' with your table name
    $result = $conn->query($sql);
...
include 'config.php';
    ...
    // Query to get user count
    $sql = "SELECT COUNT(*) AS user_count FROM categories"; // Replace 'users' with your table name
    $result = $conn->query($sql);
...
include 'config.php';
    ...
    // Query to get user count
    $sql = "SELECT COUNT(*) AS user_count FROM products"; // Replace 'users' with your table name
    $result = $conn->query($sql);
...
include 'config.php';
    ...
    // Query to get user count
    $sql = "SELECT id from categorie"; // Replace 'users' with your table name
    $result = $conn->query($sql);
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li  >
                                    <a href="products/productsindex.php">
                        ...
                        <div class="app-page-title">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo getcategoryCount() ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo getUserCount() ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">our orders</div>
                                            <div class="widget-subheading"></div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo getORDRSCount() ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo getADMINCount() ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo getproductsCount() ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
