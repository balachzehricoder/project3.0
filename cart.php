...
if (isset($_POST['submit'])) {
  ...
  foreach ($cart as $product_id => $product) {
    ...
    $sql = "INSERT INTO ORDERS (name, email, phone, address, payment, product_name, price, qty, total) VALUES ('$name', '$email', '$phone', '$address', '$payment', '$product_name', '$price', '$qty', '$total')";
